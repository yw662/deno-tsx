...
export interface ReadableStreamReadDonePiece<T> {
  done: true
  value?: T
}
export interface ReadableStreamReadValuePiece<T> {
  done: false
  value: T
}
...
export interface TextEncoderEncodeIntoPiece {
  read?: number
  written?: number
}
...
export interface HTMLBaseFontElement
  extends HTMLElement,
...
export interface SpeechRecognitionPiece {
  readonly isFinal: boolean
  readonly length: number
  item(index: number): SpeechRecognitionAlternative
  [index: number]: SpeechRecognitionAlternative
}
export interface SpeechRecognitionPieceList {
  readonly length: number
...
export interface WindowOrWorkerGlobalScope {
  ...
  setInterval<A extends any[]>(
    handler: (...args: A) => void,
    timeout?: number,
    ...args: A
  ): number
  setTimeout<A extends any[]>(
    handler: (...args: A) => void,
    timeout?: number,
    ...args: A
  ): number
...
type ReadableStreamReadPiece<T> =
  | ReadableStreamReadValuePiece<T>
  | ReadableStreamReadDonePiece<T>
...
export declare namespace Window {
  ...
  function webkitConvertPointFromNodeToPage(
    node: Node,
    pt: WebKitPoint
  ): WebKitPoint
  function webkitConvertPointFromPageToNode(
    node: Node,
    pt: WebKitPoint
  ): WebKitPoint
  ...
  function setInterval<A extends any[]>(
    handler: (...args: A) => void,
    timeout?: number,
    ...arguments: A
  ): number
  function setTimeout<A extends any[]>(
    handler: (...args: A) => void,
    timeout?: number,
    ...arguments: A
  ): number
...
export const window: typeof Window = <any>self
